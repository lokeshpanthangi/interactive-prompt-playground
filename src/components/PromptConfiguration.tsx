      ...
      <div className="space-y-6">
        <div>
          ...
          <textarea
            ...
            className="w-full h-24 px-4 py-3 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 focus:shadow-lg"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-16 px-4 py-3 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 focus:shadow-lg"
          />
        </div>
      </div>
    </div>
